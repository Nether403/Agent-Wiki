...
export const KNOWN_REPOSITORIES: Record<string, RepositoryConfig> = {
  ...
  polaris: {
    ...
    subpath: "polaris-react/src",
    defaultCategory: "ui:editorial",
    defaultTags: ["ecommerce", "b2b", "admin", "high-density", "design-system"],
    defaultDials: { design_variance: 3, motion_intensity: 2, visual_density: 9 },
    license: "MIT",
    author: "Shopify Polaris Team",
    description: "Design system and React component library for high-density e-commerce and administration.",
  },
  "gui-challenges": {
    id: "gui-challenges",
    name: "Google Chrome GUI Challenges",
    url: "https://github.com/argyleink/gui-challenges.git",
    subpath: "packages",
    defaultCategory: "ui:primitive",
    defaultTags: ["accessible", "responsive", "css", "adaptive", "web-standards"],
    defaultDials: { design_variance: 5, motion_intensity: 4, visual_density: 6 },
    license: "Apache-2.0",
    author: "Adam Argyle & Google Chrome Team",
    description: "Accessible, responsive, adaptive, and cross-browser modern web component patterns.",
  },
  iconoir: {
    id: "iconoir",
    name: "Iconoir Icons",
    url: "https://github.com/iconoir-icons/iconoir.git",
    subpath: "packages/iconoir-react",
    defaultCategory: "ui:utility",
    defaultTags: ["icons", "svg", "vector", "open-source"],
    defaultDials: { design_variance: 2, motion_intensity: 1, visual_density: 7 },
    license: "MIT",
    author: "Iconoir Community",
    description: "Neutral, high-contrast open-source SVG icon library with cross-framework support.",
  },
  fluentui: {
    id: "fluentui",
    name: "Microsoft Fluent UI",
    url: "https://github.com/microsoft/fluentui.git",
    subpath: "packages/react-components",
    defaultCategory: "ui:primitive",
    defaultTags: ["microsoft", "fluent-design", "enterprise", "accessible"],
    defaultDials: { design_variance: 3, motion_intensity: 2, visual_density: 8 },
    license: "MIT",
    author: "Microsoft",
    description: "Microsoft's cross-platform design system and UI components.",
  },
  "groot-studio": {
    id: "groot-studio",
    name: "Groot Studio",
    url: "https://github.com/Subhadipjana95/Groot-Studio.git",
    subpath: "components",
    defaultCategory: "ui:creative",
    defaultTags: ["motion/react", "creative", "framer-motion", "shaders"],
    defaultDials: { design_variance: 7, motion_intensity: 7, visual_density: 5 },
    license: "MIT",
    author: "Subhadip Jana",
    description: "Creative interactive components, animated cards, and motion effects.",
  },
  hallmark: {
    id: "hallmark",
    name: "Hallmark AI Landing Engine",
    url: "https://github.com/Nutlope/hallmark.git",
    subpath: "components",
    defaultCategory: "ui:block",
    defaultTags: ["landing", "saas", "tailwind-v4", "ai-generated"],
    defaultDials: { design_variance: 6, motion_intensity: 4, visual_density: 6 },
    license: "MIT",
    author: "Hassan El Mghari (Nutlope)",
    description: "Clean SaaS landing page components and AI web layout foundations.",
  },
  figmatocode: {
    id: "figmatocode",
    name: "FigmaToCode",
    url: "https://github.com/bernaferrari/FigmaToCode.git",
    subpath: "src",
    defaultCategory: "ui:ai-native",
    defaultTags: ["figma", "transpiler", "tailwind-v4", "codegen"],
    defaultDials: { design_variance: 5, motion_intensity: 2, visual_density: 6 },
    license: "GPL-3.0",
    author: "Bernardo Ferrari",
    description: "Figma frame-to-code transpilation engine outputting clean responsive HTML/Tailwind.",
  },
  "react-hot-toast": {
    id: "react-hot-toast",
    name: "React Hot Toast",
    url: "https://github.com/timolins/react-hot-toast.git",
    subpath: "src",
    defaultCategory: "ui:primitive",
    defaultTags: ["toast", "notifications", "accessible", "live-region"],
    defaultDials: { design_variance: 3, motion_intensity: 4, visual_density: 7 },
    license: "MIT",
    author: "Timo Lins",
    description: "Lightweight, accessible toast notifications with zero cumulative layout shift.",
  },
  vrt: {
    id: "vrt",
    name: "Visual Regression Tracker",
    url: "https://github.com/Visual-Regression-Tracker/Visual-Regression-Tracker.git",
    subpath: "packages/sdk-js",
    defaultCategory: "ui:utility",
    defaultTags: ["testing", "visual-qa", "playwright", "regression"],
    defaultDials: { design_variance: 2, motion_intensity: 1, visual_density: 8 },
    license: "Apache-2.0",
    author: "Visual Regression Tracker Community",
    description: "Visual testing and screenshot diff tracking SDK for automated design validation.",
  },
  primefaces: {
    id: "primefaces",
    name: "PrimeReact",
    url: "https://github.com/primefaces/primereact.git",
    subpath: "components/lib",
    defaultCategory: "ui:editorial",
    defaultTags: ["data-grid", "enterprise", "query-builder", "accessible"],
    defaultDials: { design_variance: 3, motion_intensity: 2, visual_density: 8 },
    license: "MIT",
    author: "PrimeTek Informatics",
    description: "Enterprise UI component suite featuring advanced data grids, query builders, and admin controls.",
  },
  webstudio: {
    id: "webstudio",
    name: "Webstudio",
    url: "https://github.com/webstudio-is/webstudio.git",
    subpath: "packages/sdk-components-react",
    defaultCategory: "ui:block",
    defaultTags: ["visual-builder", "headless-cms", "layout", "responsive"],
    defaultDials: { design_variance: 5, motion_intensity: 3, visual_density: 6 },
    license: "AGPL-3.0",
    author: "Webstudio Team",
    description: "Open-source visual website builder and Webflow alternative with headless component architecture.",
  },
  "builder-io": {
    id: "builder-io",
    name: "Builder.io",
    ...
    subpath: "packages/react",
    defaultCategory: "ui:block",
    defaultTags: ["visual-cms", "headless", "drag-and-drop", "codegen"],
    defaultDials: { design_variance: 5, motion_intensity: 3, visual_density: 6 },
    license: "MIT",
    author: "Builder.io Team",
    description: "Visual development platform connecting design systems with headless CMS drag-and-drop workflows.",
  },
  chaibuilder: {
    id: "chaibuilder",
    name: "Chai Builder SDK",
    url: "https://github.com/chaibuilder/core.git",
    subpath: "packages/core",
    defaultCategory: "ui:workflow",
    defaultTags: ["page-builder", "canvas", "sdk", "drag-drop"],
    defaultDials: { design_variance: 6, motion_intensity: 3, visual_density: 7 },
    license: "BSD-3-Clause",
    author: "Chai Builder Team",
    description: "Embeddable visual canvas page builder SDK for React and Next.js applications.",
  },
  buildingopen: {
    id: "buildingopen",
    name: "OpenPage",
    url: "https://github.com/buildingopen/openpage.git",
    subpath: "src",
    defaultCategory: "ui:block",
    defaultTags: ["open-source", "visual-editor", "tailwind-v4", "ai-layout"],
    defaultDials: { design_variance: 6, motion_intensity: 3, visual_density: 6 },
    license: "MIT",
    author: "BuildingOpen Community",
    description: "Open-source AI-assisted visual drag-and-drop website editor with JSON-first architecture.",
  },
  backstopjs: {
    id: "backstopjs",
    name: "BackstopJS",
    ...
    subpath: "core",
    defaultCategory: "ui:utility",
    defaultTags: ["visual-regression", "css-diff", "automated-qa", "playwright"],
    defaultDials: { design_variance: 2, motion_intensity: 1, visual_density: 8 },
    license: "MIT",
    author: "Garris Shipon",
    description: "Automated visual regression testing harness for catching responsive CSS layout discrepancies.",
  },
  "zag-js": {
    id: "zag-js",
    name: "Zag.js",
    url: "https://github.com/chakra-ui/zag.git",
    subpath: "packages/machines",
    defaultCategory: "ui:primitive",
    defaultTags: ["state-machines", "headless", "cross-framework", "accessible"],
    defaultDials: { design_variance: 3, motion_intensity: 3, visual_density: 6 },
    license: "MIT",
    author: "Segun Adebayo & Chakra Systems",
    description: "Finite state machine abstractions for building robust, deterministic UI component interactions.",
  },
  "stytch-ui": {
    id: "stytch-ui",
    name: "Stytch UI",
    url: "https://github.com/gamcoh/stytch-ui.git",
    subpath: "src",
    defaultCategory: "ui:primitive",
    defaultTags: ["auth", "security", "passkeys", "accessible", "login"],
    defaultDials: { design_variance: 3, motion_intensity: 2, visual_density: 7 },
    license: "MIT",
    author: "Gamcoh Community",
    description: "Zero-slop passwordless authentication cards, OTP verification dialogs, and passkey flows.",
  },
  unslop: {
    id: "unslop",
    name: "Unslop",
    url: "https://github.com/aahil62/unslop.git",
    subpath: "src",
    defaultCategory: "ui:ai-native",
    defaultTags: ["anti-slop", "refactoring", "ast-transform", "zero-slop"],
    defaultDials: { design_variance: 5, motion_intensity: 2, visual_density: 7 },
    license: "MIT",
    author: "Aahil & Contributors",
    description: "AST-level automated code remediation tool eliminating generic AI frontend tropes and slop.",
  },
  "no-ai-slop": {
    id: "no-ai-slop",
    name: "No-AI-Slop Guidelines",
    url: "https://github.com/petergyang/no-ai-slop.git",
    subpath: "rules",
    defaultCategory: "ui:utility",
    defaultTags: ["anti-slop", "ruleset", "design-taste", "guardrails"],
    defaultDials: { design_variance: 4, motion_intensity: 1, visual_density: 7 },
    license: "MIT",
    author: "Peter Yang",
    description: "Curated design rules and guardrails preventing AI agents from generating cliché UI patterns.",
  },
  "anti-slop": {
    id: "anti-slop",
    name: "Anti-Slop Linter",
    url: "https://github.com/dmmulroy/anti-slop.git",
    subpath: "src",
    defaultCategory: "ui:utility",
    defaultTags: ["linter", "anti-slop", "ast-checker", "ci-gate"],
    defaultDials: { design_variance: 2, motion_intensity: 1, visual_density: 8 },
    license: "MIT",
    author: "Dillon Mulroy",
    description: "Automated AST and regex linter scanning codebases for AI code generation anti-patterns.",
  },
  "designer-skills": {
    id: "designer-skills",
    name: "Designer Skills",
    url: "https://github.com/julianoczkowski/designer-skills.git",
    subpath: "skills",
    defaultCategory: "ui:ai-native",
    defaultTags: ["agent-skills", "prototyping", "design-workflow", "prompt-engineering"],
    defaultDials: { design_variance: 6, motion_intensity: 4, visual_density: 6 },
    license: "Apache-2.0",
    author: "Julian Oczkowski",
    description: "Process-oriented agent skills for designers prototyping and building with AI coding assistants.",
  },
  "jakubkrehel-skills": {
    ...
    subpath: "skills",
    defaultCategory: "ui:ai-native",
    defaultTags: ["agent-skills", "typography", "colour", "a11y", "layout"],
    defaultDials: { design_variance: 5, motion_intensity: 3, visual_density: 6 },
    license: "MIT",
    author: "Jakub Krehel",
    description: "Compact, modular interface, typography, color, accessibility, and product-writing skills.",
  },
  "plugin87-skills": {
    id: "plugin87-skills",
    name: "Plugin87 UX/UI Skills",
    url: "https://github.com/plugin87/ux-ui-agent-skills.git",
    subpath: "skills",
    defaultCategory: "ui:ai-native",
    defaultTags: ["agent-skills", "dtcg-tokens", "design-system", "wcag-aa"],
    defaultDials: { design_variance: 5, motion_intensity: 3, visual_density: 7 },
    license: "MIT",
    author: "Plugin87",
    description: "DTCG token-driven design architecture and senior design engineer agent playbooks.",
  },
  "maxbogo-awesome-ui": {
    id: "maxbogo-awesome-ui",
    name: "Awesome AI Tools for UI",
    url: "https://github.com/maxbogo/awesome-ai-tools-for-ui.git",
    subpath: "data",
    defaultCategory: "ui:utility",
    defaultTags: ["curated-index", "discovery", "ai-tools", "design-resources"],
    defaultDials: { design_variance: 4, motion_intensity: 1, visual_density: 8 },
    license: "MIT",
    author: "Max Bogo",
    description: "Curated discovery directory of UI-specific agent skills, plugins, MCP servers, and design tools.",
  },
  "mblode-skills": {
    id: "mblode-skills",
    name: "MBlode Agent Skills",
    url: "https://github.com/mblode/agent-skills.git",
    subpath: "skills",
    defaultCategory: "ui:ai-native",
    defaultTags: ["agent-skills", "shipping", "software-craft", "automation"],
    defaultDials: { design_variance: 4, motion_intensity: 2, visual_density: 7 },
    license: "MIT",
    author: "Matthew Blode",
    description: "Curated engineer and designer agent skills for building and shipping reliable web software.",
  },
};
