...
> = {
  ...
  "faceted-query-builder": {
    title: "Faceted Query Builder",
    description: "Cloudscape-inspired nested query rule condition builder with AND/OR group toggles and typed comparison operators.",
    category: "ui:primitive",
    tags: ["cloudscape", "enterprise", "filter", "query-builder", "faceted", "accessible"],
    dials: { design_variance: 3, motion_intensity: 2, visual_density: 7 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, wai_aria_role: "region", fallback_provided: true },
    license: { source_repository: "https://github.com/cloudscape-design/components", license_type: "Apache-2.0", author: "Cloudscape Design Team", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    registryDependencies: [],
  },
  "diff-hunk-viewer": {
    title: "Diff Hunk Viewer",
    description: "GitHub Primer style split and unified side-by-side git diff viewer with hunk navigation, line additions, and inline reviews.",
    category: "ui:editorial",
    tags: ["primer", "github", "diff", "code-review", "git", "syntax"],
    dials: { design_variance: 4, motion_intensity: 2, visual_density: 8 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, wai_aria_role: "region", fallback_provided: true },
    license: { source_repository: "https://github.com/primer/react", license_type: "MIT", author: "GitHub Primer Team", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
  ...
  "multi-pane-workspace": {
    ...
    description: "Enterprise 3-pane responsive IDE workbench layout with collapsible tree explorer, central editor, and live telemetry drawer.",
    category: "ui:block",
    tags: ["cloudscape", "fluent", "ide", "workspace", "multi-pane", "layout", "dock"],
    dials: { design_variance: 5, motion_intensity: 3, visual_density: 8 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, wai_aria_role: "region", fallback_provided: true },
    license: { source_repository: "https://github.com/microsoft/fluentui", license_type: "MIT", author: "Fluent UI / Cloudscape", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    registryDependencies: [],
  },
  "data-grid-pivot-view": {
    title: "Data Grid Pivot View",
    description: "High-density enterprise data grid with column grouping chips, dynamic summary aggregation rows, and sorting.",
    category: "ui:block",
    tags: ["reui", "ag-grid", "table", "data-grid", "pivot", "analytics"],
    dials: { design_variance: 4, motion_intensity: 2, visual_density: 8 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, wai_aria_role: "region", fallback_provided: true },
    license: { source_repository: "https://reui.io", license_type: "MIT", author: "ReUI Team", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
  ...
  "combobox-grouped-async": {
    title: "Combobox Grouped Async",
    description: "Ariakit-inspired accessible multi-select combobox with categorized option groups, async search, and removable tag chips.",
    category: "ui:primitive",
    tags: ["ariakit", "combobox", "multi-select", "search", "accessible", "tags"],
    dials: { design_variance: 3, motion_intensity: 2, visual_density: 7 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, wai_aria_role: "combobox", fallback_provided: true },
    license: { source_repository: "https://github.com/ariakit/ariakit", license_type: "MIT", author: "Ariakit Team", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    registryDependencies: [],
  },
  "query-builder-sql-tree": {
    title: "SQL Query Tree Builder",
    description: "Visual, keyboard-navigable boolean query builder with nested AND/OR rule groups and instant SQL WHERE compilation.",
    category: "ui:editorial",
    tags: ["primereact", "ant-design", "query-builder", "sql", "enterprise", "accessible"],
    dials: { design_variance: 4, motion_intensity: 2, visual_density: 8 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, wai_aria_role: "region", fallback_provided: true },
    license: { source_repository: "https://primefaces.org/primereact/querybuilder", license_type: "MIT", author: "PrimeTek & Ant Group", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    registryDependencies: [],
  },
  "visual-diff-regression-viewer": {
    title: "Visual Diff Regression Viewer",
    description: "Pixel-level screenshot and layout comparison gate with split slider, side-by-side, and difference blend modes.",
    category: "ui:ai-native",
    tags: ["visual-qa", "testing", "regression", "diff-viewer", "playwright"],
    dials: { design_variance: 6, motion_intensity: 3, visual_density: 7 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, wai_aria_role: "region", fallback_provided: true },
    license: { source_repository: "https://github.com/Visual-Regression-Tracker/Visual-Regression-Tracker", license_type: "MIT", author: "Visual Regression Tracker Community", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    registryDependencies: [],
  },
  "adaptive-touch-slider": {
    title: "Adaptive Touch Slider",
    description: "Accessible touch and gesture-aware dual slider primitive with discrete step snapping and WAI-ARIA values.",
    category: "ui:primitive",
    tags: ["gui-challenges", "react-spectrum", "slider", "touch", "accessible", "range"],
    dials: { design_variance: 3, motion_intensity: 3, visual_density: 6 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, wai_aria_role: "slider", fallback_provided: true },
    license: { source_repository: "https://github.com/argyleink/gui-challenges", license_type: "Apache-2.0", author: "Adam Argyle & Adobe React Spectrum", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["clsx", "tailwind-merge"],
    registryDependencies: [],
  },
  "infinite-canvas-spatial-ruler": {
    title: "Infinite Canvas Spatial Ruler",
    description: "Zoom-adaptive pixel grid ruler and spatial measurement HUD overlay for whiteboard and diagram applications.",
    category: "ui:workflow",
    tags: ["tldraw", "excalidraw", "canvas", "ruler", "spatial", "hud"],
    dials: { design_variance: 7, motion_intensity: 4, visual_density: 5 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, wai_aria_role: "region", fallback_provided: true },
    license: { source_repository: "https://github.com/tldraw/tldraw", license_type: "Apache-2.0", author: "tldraw & Excalidraw Team", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    registryDependencies: [],
  },
  "interactive-audio-waveform-scrubber": {
    title: "Interactive Audio Waveform Scrubber",
    description: "Frame-accurate interactive audio waveform scrubber with cue point markers, loop regions, and playback speed control.",
    category: "ui:media",
    tags: ["remocn", "remotion", "audio", "waveform", "timeline", "scrubber"],
    dials: { design_variance: 6, motion_intensity: 7, visual_density: 6 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, wai_aria_role: "slider", fallback_provided: true, reduced_motion_supported: true },
    license: { source_repository: "https://remocn.dev", license_type: "MIT", author: "Remocn & Remotion Team", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    registryDependencies: [],
  },
  "ai-agent-evaluation-scoreboard": {
    title: "AI Agent Evaluation Scoreboard",
    description: "Multi-model benchmark leaderboard showing first-run compilation rates, slop health scores, latency, and cost per prompt.",
    category: "ui:ai-native",
    tags: ["ai-native", "benchmark", "evaluation", "scoreboard", "analytics"],
    dials: { design_variance: 6, motion_intensity: 3, visual_density: 8 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, wai_aria_role: "table", fallback_provided: true },
    license: { source_repository: "https://design-wiki.dev", license_type: "MIT", author: "Machine-First Design Agent Wiki Team", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    registryDependencies: [],
  },
  "dynamic-theme-matrix-inspector": {
    title: "Dynamic Theme Matrix Inspector",
    description: "W3C DTCG-compliant design token inspector and contrast matrix validator with light/dark simulation.",
    category: "ui:utility",
    tags: ["tokens-studio", "style-dictionary", "tokens", "dtcg", "contrast", "theme"],
    dials: { design_variance: 3, motion_intensity: 2, visual_density: 8 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, fallback_provided: true },
    license: { source_repository: "https://github.com/tokens-studio/figma-plugin", license_type: "MIT", author: "Tokens Studio & Amazon Style Dictionary", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    registryDependencies: [],
  },
  "subgrid-responsive-layout": {
    title: "Subgrid Responsive Layout",
    description: "CSS Subgrid and Container Query card layout with aligned headers, feature checklists, and footer actions across columns.",
    category: "ui:block",
    tags: ["gui-challenges", "subgrid", "container-queries", "marketing", "cards"],
    dials: { design_variance: 5, motion_intensity: 2, visual_density: 6 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, fallback_provided: true },
    license: { source_repository: "https://github.com/argyleink/gui-challenges", license_type: "Apache-2.0", author: "Adam Argyle & Google Chrome Team", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    registryDependencies: [],
  },
  "state-machine-flow-controller": {
    title: "State Machine Flow Controller",
    description: "Visual Zag.js-inspired state machine node controller displaying active state, available transition events, and audit logs.",
    category: "ui:workflow",
    tags: ["zag-js", "ark-ui", "state-machine", "interactive", "workflow"],
    dials: { design_variance: 6, motion_intensity: 4, visual_density: 7 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, wai_aria_role: "region", fallback_provided: true },
    license: { source_repository: "https://github.com/chakra-ui/zag", license_type: "MIT", author: "Segun Adebayo & Chakra Systems", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    registryDependencies: [],
  },
  "multi-step-wizard-flow": {
    title: "Multi-Step Wizard Flow",
    description: "Accessible multi-step form wizard with progress indicators, per-step validation states, and draft preservation.",
    category: "ui:primitive",
    tags: ["mantine", "formik", "wizard", "stepper", "form", "accessible"],
    dials: { design_variance: 3, motion_intensity: 3, visual_density: 6 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, fallback_provided: true },
    license: { source_repository: "https://github.com/mantinedev/mantine", license_type: "MIT", author: "Vitaly Rtishchev & Jared Palmer", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    registryDependencies: [],
  },
  "kinetic-typography-marquee": {
    title: "Kinetic Typography Marquee",
    description: "Variable font weight stream with smooth infinite CSS loop, edge masking, and prefers-reduced-motion support.",
    category: "ui:creative",
    tags: ["motion", "paper-shaders", "kinetic-type", "marquee", "typography"],
    dials: { design_variance: 8, motion_intensity: 8, visual_density: 4 },
    a11y: { keyboard_navigable: false, wai_aria_compliant: true, fallback_provided: true, reduced_motion_supported: true },
    license: { source_repository: "https://github.com/motiondivision/motion", license_type: "MIT", author: "Motion Division & Paper Design", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["clsx", "tailwind-merge"],
    registryDependencies: [],
  },
  "realtime-telemetry-gauge-cluster": {
    title: "Realtime Telemetry Gauge Cluster",
    description: "SVG circular telemetry cluster for CPU/memory loads, edge latency percentiles, and SLA target indicators.",
    category: "ui:editorial",
    tags: ["cloudscape", "primer", "telemetry", "gauges", "dashboard", "metrics"],
    dials: { design_variance: 4, motion_intensity: 3, visual_density: 8 },
    a11y: { keyboard_navigable: false, wai_aria_compliant: true, wai_aria_role: "region", fallback_provided: true },
    license: { source_repository: "https://cloudscape.design", license_type: "Apache-2.0", author: "Amazon Web Services & GitHub Primer", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    registryDependencies: [],
  },
  "interactive-matrix-filter-pill-group": {
    title: "Interactive Matrix Filter Pill Group",
    description: "Keyboard-navigable faceted pill group with multi-select tag toggles, count badges, and clear-all triggers.",
    category: "ui:primitive",
    tags: ["primer", "heroui", "filter-pills", "faceted", "accessible", "tags"],
    dials: { design_variance: 3, motion_intensity: 2, visual_density: 7 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, fallback_provided: true },
    license: { source_repository: "https://primer.style", license_type: "MIT", author: "GitHub Primer & HeroUI Team", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    registryDependencies: [],
  },
  "split-pane-code-preview-comparator": {
    title: "Split Pane Code Preview Comparator",
    description: "Side-by-side AST before/after unslop code comparator with health score deltas and instant copy action.",
    category: "ui:ai-native",
    tags: ["unslop", "anti-slop", "code-diff", "comparator", "ast-refactor"],
    dials: { design_variance: 6, motion_intensity: 3, visual_density: 7 },
    a11y: { keyboard_navigable: true, wai_aria_compliant: true, fallback_provided: true },
    license: { source_repository: "https://github.com/aahil62/unslop", license_type: "MIT", author: "Aahil & Dillon Mulroy", attribution_required: true, redistribution_mode: "full_source" },
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
    registryDependencies: [],
  },
};
