...
> Drag-and-drop zone with MIME validation, file size limits, thumbnail generation, upload progress bars, and abort buttons.

- **Taxonomy Category**: `ui:primitive`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: lucide-react, tailwind-v4, brutalist, accessible, keyboard-accessible, wai-aria-compliant, layout-block, form, file-upload, drag-drop, reui
...
npx design-wiki add file-upload-dropzone

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/file-upload-dropzone.json
```
