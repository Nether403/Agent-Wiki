---
id: "competitor-comparison-matrix"
name: "Competitor Comparison Matrix"
category: "ui:utility"
...
- **Technical Tags**: lucide-react, tailwind-v4, wai-aria-compliant, utility
...
npx design-wiki add competitor-comparison-matrix

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/competitor-comparison-matrix.json
```
