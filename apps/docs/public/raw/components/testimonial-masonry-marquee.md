---
id: "testimonial-masonry-marquee"
name: "Testimonial Masonry Marquee Grid"
category: "ui:block"
...
# Testimonial Masonry Marquee Grid (`testimonial-masonry-marquee`)
> Masonry grid of verified user review cards with avatar verification and star ratings.

- **Taxonomy Category**: `ui:block`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: lucide-react, bento-grid, tailwind-v4, wai-aria-compliant, block, testimonials, masonry, reviews, tailark
...
npx design-wiki add testimonial-masonry-marquee

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/testimonial-masonry-marquee.json
```
