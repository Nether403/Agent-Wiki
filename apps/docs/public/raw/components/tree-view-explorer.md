...
# Tree View File Explorer (`tree-view-explorer`)
> Accessible hierarchical file/folder tree view with expand/collapse animations, keyboard navigation, and custom node icons.

- **Taxonomy Category**: `ui:primitive`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: lucide-react, tailwind-v4, accessible, keyboard-accessible, wai-aria-compliant, layout-block, tree-view, file-explorer, hierarchy, shark-ui
...
npx design-wiki add tree-view-explorer

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/tree-view-explorer.json
```
