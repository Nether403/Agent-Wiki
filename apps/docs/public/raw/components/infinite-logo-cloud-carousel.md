---
id: "infinite-logo-cloud-carousel"
name: "Infinite Logo Cloud Carousel"
...
# Infinite Logo Cloud Carousel (`infinite-logo-cloud-carousel`)
...
npx design-wiki add infinite-logo-cloud-carousel

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/infinite-logo-cloud-carousel.json
```
