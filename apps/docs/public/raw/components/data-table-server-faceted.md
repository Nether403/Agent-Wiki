---
id: "data-table-server-faceted"
name: "Data Table Server Faceted"
category: "ui:block"
...
# Data Table Server Faceted (`data-table-server-faceted`)
> Enterprise data table with column pinning, multi-facet filtering, and keyboard navigation.

- **Taxonomy Category**: `ui:block`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: lucide-react, tailwind-v4, accessible, keyboard-accessible, wai-aria-compliant, layout-block, block, table, data-grid, faceted, primer
...
npx design-wiki add data-table-server-faceted

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/data-table-server-faceted.json
```
