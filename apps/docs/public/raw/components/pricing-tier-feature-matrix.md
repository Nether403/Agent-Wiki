---
id: "pricing-tier-feature-matrix"
name: "Pricing Tier Feature Matrix"
category: "ui:block"
library_origin: "https://github.com/launch-ui/launch-ui"
dependencies:
  - "lucide-react"
  - "clsx"
  - "tailwind-merge"
...
# Pricing Tier Feature Matrix (`pricing-tier-feature-matrix`)
> Multi-tier plan comparator with monthly/annual billing cycle toggle, feature breakdown list with tooltips, and highlighted tier callout.

- **Taxonomy Category**: `ui:block`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: lucide-react, bento-grid, tailwind-v4, brutalist, accessible, keyboard-accessible, wai-aria-compliant, layout-block, pricing, billing, matrix, saas, landing, launch-ui, page-ui
...
npx design-wiki add pricing-tier-feature-matrix

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/pricing-tier-feature-matrix.json
```
