---
id: "branch-diff-tree-inspector"
name: "Branch Diff Tree Inspector"
...
# Branch Diff Tree Inspector (`branch-diff-tree-inspector`)
...
npx design-wiki add branch-diff-tree-inspector

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/branch-diff-tree-inspector.json
```
