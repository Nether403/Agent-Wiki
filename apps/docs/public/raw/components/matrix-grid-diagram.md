...
# Matrix Grid Diagram (`matrix-grid-diagram`)
> Curated production-grade component.

- **Taxonomy Category**: `ui:block`
- **Structural Complexity**: `MEDIUM`
- **Technical Tags**: bento-grid, tailwind-v4, wai-aria-compliant, layout-block
...
npx design-wiki add matrix-grid-diagram

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/matrix-grid-diagram.json
```
