---
id: "tracing-beam-scroll"
name: "Tracing Beam Scroll"
category: "ui:motion"
...
# Tracing Beam Scroll (`tracing-beam-scroll`)
...
npx design-wiki add tracing-beam-scroll

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/tracing-beam-scroll.json
```
