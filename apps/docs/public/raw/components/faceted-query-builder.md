---
id: "faceted-query-builder"
name: "Faceted Query Builder"
category: "ui:primitive"
library_origin: "https://github.com/cloudscape-design/components"
dependencies:
  - "lucide-react"
  - "clsx"
  - "tailwind-merge"
...
# Faceted Query Builder (`faceted-query-builder`)
> Cloudscape-inspired nested query rule condition builder with AND/OR group toggles and typed comparison operators.

- **Taxonomy Category**: `ui:primitive`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: lucide-react, tailwind-v4, accessible, keyboard-accessible, wai-aria-compliant, layout-block, cloudscape, enterprise, filter, query-builder, faceted
...
npx design-wiki add faceted-query-builder

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/faceted-query-builder.json
```
