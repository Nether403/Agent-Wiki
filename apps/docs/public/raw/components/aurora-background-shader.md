---
id: "aurora-background-shader"
name: "Aurora Background Shader"
...
# Aurora Background Shader (`aurora-background-shader`)
> Curated production-grade component.

- **Taxonomy Category**: `ui:creative`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: webgl, threejs, wai-aria-compliant, canvas
...
npx design-wiki add aurora-background-shader

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/aurora-background-shader.json
```
