---
id: "image-mouse-trail"
name: "Image Pointer Mouse Trail"
category: "ui:motion"
...
# Image Pointer Mouse Trail (`image-mouse-trail`)
> Interactive pointer trail displaying trailing layered images with velocity-sensitive rotation and fade-out.

- **Taxonomy Category**: `ui:motion`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: tailwind-v4, wai-aria-compliant, motion, mouse-trail, interactive, react-bits
...
npx design-wiki add image-mouse-trail

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/image-mouse-trail.json
```
