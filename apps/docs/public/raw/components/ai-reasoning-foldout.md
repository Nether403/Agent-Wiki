---
id: "ai-reasoning-foldout"
name: "Ai Reasoning Foldout"
...
# Ai Reasoning Foldout (`ai-reasoning-foldout`)
...
npx design-wiki add ai-reasoning-foldout

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/ai-reasoning-foldout.json
```
