---
id: "decision-tree-node-graph"
name: "Decision Tree Node Graph"
category: "ui:block"
...
# Decision Tree Node Graph (`decision-tree-node-graph`)
...
npx design-wiki add decision-tree-node-graph

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/decision-tree-node-graph.json
```
