---
id: "variable-font-slider"
name: "Variable Font Slider"
...
# Variable Font Slider (`variable-font-slider`)
...
npx design-wiki add variable-font-slider

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/variable-font-slider.json
```
