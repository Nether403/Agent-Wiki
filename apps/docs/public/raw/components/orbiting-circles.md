---
id: "orbiting-circles"
name: "Orbiting Planetary Circles"
category: "ui:motion"
...
# Orbiting Planetary Circles (`orbiting-circles`)
> Nested rotating orbits carrying technology/brand icons with configurable speed and direction.

- **Taxonomy Category**: `ui:motion`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: lucide-react, tailwind-v4, wai-aria-compliant, motion, orbiting-circles, magic-ui, planetary
...
npx design-wiki add orbiting-circles

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/orbiting-circles.json
```
