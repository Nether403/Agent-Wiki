---
id: "ai-human-in-the-loop-diff"
name: "AI Human-in-the-Loop Diff Drawer"
...
# AI Human-in-the-Loop Diff Drawer (`ai-human-in-the-loop-diff`)
> Interactive confirmation drawer displaying code diffs with Approve, Modify Prompt, and Reject feedback controls.
...
npx design-wiki add ai-human-in-the-loop-diff

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/ai-human-in-the-loop-diff.json
```
