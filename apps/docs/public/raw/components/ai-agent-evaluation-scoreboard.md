---
id: "ai-agent-evaluation-scoreboard"
name: "AI Agent Evaluation Scoreboard"
...
# AI Agent Evaluation Scoreboard (`ai-agent-evaluation-scoreboard`)
> Multi-model benchmark leaderboard showing first-run compilation rates, slop health scores, latency, and cost per prompt.

- **Taxonomy Category**: `ui:ai-native`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: lucide-react, tailwind-v4, accessible, keyboard-accessible, wai-aria-compliant, ai-native, agent-ui, benchmark, evaluation, scoreboard, analytics
...
npx design-wiki add ai-agent-evaluation-scoreboard

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/ai-agent-evaluation-scoreboard.json
```
