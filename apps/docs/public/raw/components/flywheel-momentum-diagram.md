---
id: "flywheel-momentum-diagram"
name: "Flywheel Momentum Diagram"
category: "ui:block"
...
# Flywheel Momentum Diagram (`flywheel-momentum-diagram`)
...
npx design-wiki add flywheel-momentum-diagram

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/flywheel-momentum-diagram.json
```
