---
id: "media-scrubber-timeline"
name: "Media Scrubber Timeline"
category: "ui:media"
...
# Media Scrubber Timeline (`media-scrubber-timeline`)
...
npx design-wiki add media-scrubber-timeline

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/media-scrubber-timeline.json
```
