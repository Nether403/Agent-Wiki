---
id: "color-picker-primitive"
name: "Color Picker Primitive"
category: "ui:primitive"
library_origin: "https://github.com/chakra-ui/ark"
dependencies:
  - "lucide-react"
  - "clsx"
  - "tailwind-merge"
...
# Color Picker Primitive (`color-picker-primitive`)
> Accessible headless color picker with hex/rgb input, palette swatches, and clipboard copy.

- **Taxonomy Category**: `ui:primitive`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: lucide-react, bento-grid, tailwind-v4, accessible, keyboard-accessible, wai-aria-compliant, primitive, color-picker, form, headless, ark-ui
...
npx design-wiki add color-picker-primitive

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/color-picker-primitive.json
```
