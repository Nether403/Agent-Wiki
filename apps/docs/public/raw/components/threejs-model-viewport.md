---
id: "threejs-model-viewport"
name: "Threejs Model Viewport"
...
# Threejs Model Viewport (`threejs-model-viewport`)
> Curated production-grade component.

- **Taxonomy Category**: `ui:creative`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: lucide-react, webgl, threejs, canvas, tailwind-v4, wai-aria-compliant
...
npx design-wiki add threejs-model-viewport

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/threejs-model-viewport.json
```
