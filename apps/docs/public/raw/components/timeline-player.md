...
> Precision timeline-based motion and video composition controller with frame scrubbing and timecode.
...
npx design-wiki add timeline-player

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/timeline-player.json
```
