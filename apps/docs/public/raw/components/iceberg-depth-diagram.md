---
id: "iceberg-depth-diagram"
name: "Iceberg Depth Diagram"
category: "ui:block"
...
# Iceberg Depth Diagram (`iceberg-depth-diagram`)
...
npx design-wiki add iceberg-depth-diagram

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/iceberg-depth-diagram.json
```
