---
id: "laser-flow-border-card"
name: "Laser Flow Border Card"
...
# Laser Flow Border Card (`laser-flow-border-card`)
> Card with continuous directional laser pulse border animation using SVG and CSS conic gradients with reduced-motion fallback.

- **Taxonomy Category**: `ui:creative`
- **Structural Complexity**: `MEDIUM`
- **Technical Tags**: lucide-react, tailwind-v4, neon-scifi, accessible, keyboard-accessible, wai-aria-compliant, creative, laser, border, card, cult-ui, glow, conic-gradient
...
npx design-wiki add laser-flow-border-card

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/laser-flow-border-card.json
```
