...
> Multi-thumb range slider with floating value tooltips, min/max bounds clamping, and step markers.

- **Taxonomy Category**: `ui:primitive`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: brutalist, accessible, keyboard-accessible, wai-aria-compliant, form, slider, range, heroui
...
npx design-wiki add dual-range-slider

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/dual-range-slider.json
```
