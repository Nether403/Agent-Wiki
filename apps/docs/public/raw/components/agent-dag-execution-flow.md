---
id: "agent-dag-execution-flow"
name: "Agent D A G Execution Flow"
category: "ui:block"
...
# Agent D A G Execution Flow (`agent-dag-execution-flow`)
...
npx design-wiki add agent-dag-execution-flow

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/agent-dag-execution-flow.json
```
