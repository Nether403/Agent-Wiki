---
id: "flowchart-process-graph"
name: "Flowchart Process Graph"
...
# Flowchart Process Graph (`flowchart-process-graph`)
...
npx design-wiki add flowchart-process-graph

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/flowchart-process-graph.json
```
