---
id: "strategy-canvas-value-curve"
name: "Strategy Canvas Value Curve"
...
# Strategy Canvas Value Curve (`strategy-canvas-value-curve`)
> Blue Ocean Strategy value curve comparison diagram plotting competitor performance against industry factors.

- **Taxonomy Category**: `ui:editorial`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: webgl, threejs, tailwind-v4, accessible, keyboard-accessible, wai-aria-compliant, canvas, diagram, strategy, value-curve, blue-ocean, comparison, diagram-design
...
npx design-wiki add strategy-canvas-value-curve

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/strategy-canvas-value-curve.json
```
