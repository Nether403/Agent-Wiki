---
id: "interactive-pagination-bar"
name: "Interactive Pagination Bar"
...
# Interactive Pagination Bar (`interactive-pagination-bar`)
...
npx design-wiki add interactive-pagination-bar

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/interactive-pagination-bar.json
```
