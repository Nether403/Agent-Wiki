---
id: "visual-diff-regression-viewer"
name: "Visual Diff Regression Viewer"
category: "ui:ai-native"
library_origin: "https://github.com/Visual-Regression-Tracker/Visual-Regression-Tracker"
dependencies:
  - "lucide-react"
  - "clsx"
  - "tailwind-merge"
...
# Visual Diff Regression Viewer (`visual-diff-regression-viewer`)
> Pixel-level screenshot and layout comparison gate with split slider, side-by-side, and difference blend modes.

- **Taxonomy Category**: `ui:ai-native`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: lucide-react, bento-grid, tailwind-v4, accessible, keyboard-accessible, wai-aria-compliant, layout-block, visual-qa, testing, regression, diff-viewer, playwright
...
npx design-wiki add visual-diff-regression-viewer

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/visual-diff-regression-viewer.json
```
