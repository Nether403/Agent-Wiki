...
name: "Virtualized Search Combobox"
...
# Virtualized Search Combobox (`combobox-virtualized`)
> High-performance search combobox handling 10,000+ items via virtualization, with keyboard navigation and async loading states.

- **Taxonomy Category**: `ui:primitive`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: lucide-react, tailwind-v4, accessible, keyboard-accessible, wai-aria-compliant, layout-block, combobox, virtualized, large-list, shark-ui
...
npx design-wiki add combobox-virtualized

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/combobox-virtualized.json
```
