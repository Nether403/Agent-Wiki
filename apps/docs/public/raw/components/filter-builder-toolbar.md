---
id: "filter-builder-toolbar"
name: "Filter Builder Toolbar"
category: "ui:block"
...
# Filter Builder Toolbar (`filter-builder-toolbar`)
...
npx design-wiki add filter-builder-toolbar

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/filter-builder-toolbar.json
```
