---
id: "query-builder-sql-tree"
name: "SQL Query Tree Builder"
category: "ui:editorial"
library_origin: "https://primefaces.org/primereact/querybuilder"
dependencies:
  - "lucide-react"
  - "clsx"
  - "tailwind-merge"
...
# SQL Query Tree Builder (`query-builder-sql-tree`)
> Visual, keyboard-navigable boolean query builder with nested AND/OR rule groups and instant SQL WHERE compilation.

- **Taxonomy Category**: `ui:editorial`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: lucide-react, tailwind-v4, accessible, keyboard-accessible, wai-aria-compliant, layout-block, primereact, ant-design, query-builder, sql, enterprise
...
npx design-wiki add query-builder-sql-tree

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/query-builder-sql-tree.json
```
