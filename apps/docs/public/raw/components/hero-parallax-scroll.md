...
name: "Hero 3D Parallax Scroll Showcase"
category: "ui:block"
...
# Hero 3D Parallax Scroll Showcase (`hero-parallax-scroll`)
> Multi-row 3D perspective image grid that shifts and rotates as the user scrolls down the page.

- **Taxonomy Category**: `ui:block`
- **Structural Complexity**: `HIGH`
- **Technical Tags**: lucide-react, bento-grid, tailwind-v4, glassmorphism, accessible, keyboard-accessible, wai-aria-compliant, layout-block, block, hero, parallax, 3d-perspective, aceternity
...
npx design-wiki add hero-parallax-scroll

# Or via shadcn v3
npx shadcn@latest add http://localhost:3000/r/hero-parallax-scroll.json
```
